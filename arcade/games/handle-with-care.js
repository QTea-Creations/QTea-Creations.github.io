...
function findTutorialPiece(text) {
  return (
    activePieces.find(
      (piece) =>
        !piece.removed &&
  ...
  switch (tutorialStep) {
    ...
    case 6: {
      const privatePiece =
        ...
        findTutorialPiece("Home Address");
...
function completeTutorial() {
  ...
  showFeedback({
    ...
    message:
      "All three factory lines are now open!",
    points: "+50"
  });
